...
export default function EducationForm({resumeData,setResumeData}:EditorFormProps){
    ...
    <div className="max-w-xl mx-auto space-y-6">
        <div className="space-y-1.5 text-center">
            ...
            <p className="text-sm text-muted-foreground ">Add as many Education as you like.</p>
        </div>
        <Form {...form}>
...
function EducationItem({id,form,index,remove}:EducationItemProps){
   ...
   return (<div className={cn("space-y-3 border rounded-md bg-background p-3",isDragging && "shadow-xl z-50 cursor-grab relative")}
            ref={setNodeRef}
            style={{
